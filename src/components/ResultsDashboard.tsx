                  ...
                  {showAdvancedAdmin && (
                    <div className="space-y-3 p-3 border border-gray-200 rounded-lg bg-blue-50">
                      ...
                      <div className="p-3 border border-gray-200 rounded-lg bg-white">
                        ...
                        >
                          <option value="auto">Auto (GPT-4o-mini → Claude 3.5 Sonnet → Gemini Flash)</option>
                          <option value="openai">Forcer GPT-4o-mini uniquement</option>
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                          Auto : essaie GPT-4o-mini → Claude 3.5 Sonnet → Gemini Flash si échec
                        </p>
                      </div>
                    </div>
                  )}
